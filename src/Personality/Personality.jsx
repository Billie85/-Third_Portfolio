...
import MyPicture from '/42Tokyo2.jpg';
    ...
    <>
      <div className={Desktop.container}>
        ...
        <div className={Desktop.IntroduceContainer}>
          <h1>飲み会のノリで学ぶ</h1>
          <p>
              自己紹介でも紹介しているのですが、私は2年半42Tokyoに在籍していました。
              ...
              まず、42Tokyoの最大の特徴はその自由さです。従来の学校のように、教師がいて授業があるわけではありません。生徒同士が自発的に学び合い、助け合う環境が整っています。<br />
              課題が与えられ、それをクリアするために必要なスキルや知識を自分で探し、学んでいくプロセスは、まるで仲間と一緒に難問に挑戦するアドベンチャーゲームのようです。<br />
              この自主性が要求される環境は、飲み会のノリでわいわいと楽しみながらも、確実に成長していくことができる理由の一つです。
              また、42Tokyoには年齢やバックグラウンドが異なる多様なメンバーが集まっています。<br />
              新卒の学生から、キャリアチェンジを目指す社会人まで、様々な人が一つのコミュニティに共存しています。この異なるバックグラウンドを持つメンバー同士の交流が、新しいアイデアや視点を生み出し、プロジェクトに新たな刺激を与えてくれます。
              さらに、42Tokyoでは評価の方法も独特です。<br />
